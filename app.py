    ...
    for page_i, data in enumerate(extracted_pages):
        for cat_in in (data.get("categories") or []):
            ...
            for it in (cat_in.get("items") or []):
                ...
                # --- MODIFICATION: Smart dietary tag processing ---
                params_json_obj = {}
                ...
                # Use sets for efficient, unique merging
                ...
                # Now, filter into the two groups
...
with tab1:
    ...
    if st.button("Extract and Build JSON"):
        ...
        fn_slug = re.sub(r'[^a-z0-9_]', '', fn_slug) 
...
with tab2:
    ...
    if st.button("Transform", key="btn2"):
        ...
        fn_slug_2 = re.sub(r'[^a-z0-9_]', '', fn_slug_2) 
